...
vnoremap    <buffer>  <silent>  <Leader>cj    <Esc>:call C_AdjustLineEndComm("v")<CR>
 ...
 noremap    <buffer>  <silent>  <Leader>cfh    <Esc>:call C_CommentTemplates("cheader")<CR>
vnoremap    <buffer>  <silent>  <Leader>cfh    <Esc>:call C_CommentTemplates("cheader")<CR>
 noremap    <buffer>  <silent>  <Leader>chh    <Esc>:call C_CommentTemplates("hheader")<CR>
vnoremap    <buffer>  <silent>  <Leader>chh    <Esc>:call C_CommentTemplates("hheader")<CR>
